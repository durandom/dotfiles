# Generated by Powerlevel10k configuration wizard on 2022-11-16 at 12:37 CET.
...
() {
  ...
  # typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_SUFFIX='%244F─╮' # conflicts with tmux yank
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_SUFFIX=''  # conflicts with tmux yank
  ...
  # Custom icon to black hexagon font color green
